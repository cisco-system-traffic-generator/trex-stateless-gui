...
public class DashboardTabChartsContainer extends AnchorPane {
    ...
    public DashboardTabChartsContainer(String selectedType, IntegerProperty interval) {
        ...
        contextMenu.getItems().addAll(
                ...
                createContextMenuItem(DashboardTabChartsFactory.ChartTypes.TX_PKTS_PER_SECOND),
                createContextMenuItem(DashboardTabChartsFactory.ChartTypes.RX_PKTS_PER_SECOND),
                createContextMenuItem(DashboardTabChartsFactory.ChartTypes.TX_BYTES_PER_SECOND_L1),
                createContextMenuItem(DashboardTabChartsFactory.ChartTypes.TX_BYTES_PER_SECOND_L2),
                createContextMenuItem(DashboardTabChartsFactory.ChartTypes.RX_BYTES_PER_SECOND),
                new SeparatorMenuItem(),
    ...
    public void update(Set<Integer> visiblePorts, Set<String> visibleStreams) {
        chart.update(visiblePorts, visibleStreams);
    ...
    private void handleChartTypeChanged(
        ...
        chart.update(lastVisiblePorts, lastVisibleStreams);
