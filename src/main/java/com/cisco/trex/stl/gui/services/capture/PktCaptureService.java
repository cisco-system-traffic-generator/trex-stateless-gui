...
public class PktCaptureService extends ScheduledService<CapturedPackets>
    ...
    private TRexClient tRexClient = TrexApp.injector.getInstance(TRexClient.class);
    ...
    public CapturedPackets fetchCapturedPkts(int captureId, int chunkSize) throws PktCaptureServiceException {
